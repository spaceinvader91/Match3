...
public class CreateGame : MonoBehaviour
{
    ...
    void RenewGrid()
    {
        ...
        if (!anyMoved)
        {
            //check for board state with CheckGrid and new bool to check if there are any valid moves left
        }
        ...
        else if (Input.GetMouseButtonUp(0) && tile1)
        {
            ...
            if (tile1 && tile2)
            {
                ...
                if (validMove)
                {
                    ...
                    {
                        //Play cant swap sound
                        print("Tiles not next to each other!");
                    }
                }
    ...
    void MoveCheck(GameObject tile2)
    {
        int matchCount = 0;
        //check tiles around tile 2 for matches, if found,  move is valid
